...
import { slideLeft, slideRight, fadeUp, viewportOnce } from "@/lib/animations";
  ...
  return (
    <Section>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        <motion.div initial={slideLeft.hidden} whileInView={slideLeft.visible} viewport={viewportOnce} transition= duration: 0.5, delay: 0 >
        ...
        <motion.div initial={slideRight.hidden} whileInView={slideRight.visible} viewport={viewportOnce} transition= duration: 0.5, delay: 0 >
